...
values
  ...
  ('contact_received',
   ...
   '["name","topic"]'::jsonb),
  ('toshare_form_submitted',
   'toShare form submission',
  ...
  ('toshare_quote_accepted',
   'toShare quote accepted',
  ...
  ('toshare_booking_invitee',
   'toShare booking confirmation (invitee)',
  ...
  ('toshare_booking_host',
   'toShare booking notification (host)',
