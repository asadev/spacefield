...
### public.share_links
Created in `20260502_share_links.sql` (+branding in `20260502_share_branding.sql`). Minted shareable links.
- `workspace_id → public.workspaces.id`
- `user_id → auth.users.id`

### public.share_events
Created in `20260502_share_links.sql` (+accept in `20260502_share_accept.sql`, +booking in `20260502_share_booking.sql`). Visitor activity per link (view, submit, accept, book).
- `link_id → public.share_links.id`

### public.share_webhook_deliveries
Created in `20260502_share_webhook_log.sql` (+secret rotation in `20260502_share_webhook_secret.sql`). Outbound webhook delivery log.
- `link_id → public.share_links.id`
