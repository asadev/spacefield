...
- `public.share_links.owner_user_id`  *(from `20260502_share_links.sql`)*
...
### `public.share_links`  _(referenced by 2 FKs)_

**`ON DELETE CASCADE` — 2 FK(s):**
- `public.share_events.link_id`  *(from `20260502_share_links.sql`)*
- `public.share_webhook_deliveries.link_id`  *(from `20260502_share_webhook_log.sql`)*
...
- `public.share_links.workspace_id`  *(from `20260502_share_links.sql`)*
- `public.share_webhook_deliveries.workspace_id`  *(from `20260502_share_webhook_log.sql`)*
