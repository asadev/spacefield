...
/* Developer Pipeline Tracker — native window app.
 *
 ...
 *   ≥ 1400 → 5 kanban columns / 3 dev cards / wide chart row
 *   ≥ 1100 → 3 kanban / 3 dev cards
 *   ≥ 820  → 2 kanban / 2 dev cards
 *   <  820 → 1 column everywhere
 *
...
function StatusDonut({ projects, tone }: { projects: Project[]; tone: string }) {
  const canvasRef = useRef<HTMLCanvasElement>(null);
...
function ToolAppHeader({
  ...
  return (
    <div className="tool-hero relative overflow-hidden rounded-t-xl border-b border-app">
      <div
        aria-hidden
      ...
      <div
        className={`relative flex gap-4 px-5 py-5 ${
          compact ? "flex-col" : "flex-col md:flex-row md:items-end md:justify-between md:px-6 md:py-6"
        }`}
      >
        <div className="min-w-0">
          ...
          <h1
            className={`mt-2 font-bold leading-tight tracking-tight text-app ${
              compact ? "text-[1.4rem]" : "text-[1.55rem] md:text-[1.85rem]"
            }`}
          >
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <StatChip label="Units" value={stats.totalUnits.toLocaleString()} />
...
/* ═════════════════════════════ MAIN APP ═════════════════════════════ */
export default function DeveloperPipelineApp({
  width,
  resolved,
}: NativeAppProps) {
  ...
  const kanbanCols =
    width >= 1400
      ...
      : "grid-cols-1";
  const listCols =
    width >= 1100 ? "grid-cols-3" : width >= 820 ? "grid-cols-2" : "grid-cols-1";
  const devCols =
    width >= 1100 ? "grid-cols-3" : width >= 820 ? "grid-cols-2" : "grid-cols-1";
  const chartCols = width >= 1100 ? "grid-cols-2" : "grid-cols-1";
  const timelineProjectsCols =
    width >= 1100 ? "grid-cols-3" : width >= 820 ? "grid-cols-2" : "grid-cols-1";
  ...
  return (
    ...
    >
      <section className="px-4 py-4 sm:px-5 sm:py-5">
        ...
        >
          <ToolAppHeader stats={stats} compact={compact} />
            ...
            <AnimatePresence mode="wait">
              ...
              {activeTab === "projects" && (
                ...
                >
                  ...
                  {/* ───── KANBAN ───── */}
                  {viewMode === "kanban" && (
                    <div className={`grid gap-3 ${kanbanCols}`}>
                  ...
                  {/* ───── LIST ───── */}
                  {viewMode === "list" && (
                    <div className={`grid gap-3 ${listCols}`}>
                        ...
                        {timelineData.map(([quarter, projects]) => {
                          ...
                          return (
                            <div key={quarter} className="relative pl-6">
                              ...
                              <div className={`grid gap-2 ${timelineProjectsCols}`}>
                                {projects.map((p) => (
                                  <ProjectTile
                                    key={p.name}
                                    project={p}
              ...
              {activeTab === "developers" && (
                ...
                >
                  ...
                  <div className={`mb-8 grid gap-3 ${devCols}`}>
                  ...
                  <div className={`grid gap-4 ${chartCols}`}>
                    <div className="rounded-xl border border-app bg-app-elevated p-5">
                      ...
                      <div className="flex justify-center overflow-x-auto">
                        <DeveloperChart developers={DEVELOPERS} tone={tone} />
                      </div>
                    </div>
                    <div className="rounded-xl border border-app bg-app-elevated p-5">
                      <h4 className="mb-4 text-[11px] font-semibold uppercase tracking-[0.22em] text-tool-accent">
                      ...
                      <div className="flex justify-center">
                        <StatusDonut projects={PROJECTS} tone={tone} />
                      </div>
                    </div>
                  </div>
                </motion.div>
              ...
              {activeTab === "timeline" && (
                ...
                >
                  <div className="mb-6 rounded-xl border border-app bg-app-elevated p-5">
                    ...
                    <div className="flex justify-center">
                      <UnitsByYearChart projects={PROJECTS} tone={tone} />
                    </div>
                  </div>
