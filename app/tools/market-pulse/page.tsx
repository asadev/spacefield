  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-2xl md:text-3xl font-semibold text-app tracking-tight">
                Market Pulse
              </h1>
        ...
        <div className="inline-flex items-center p-0.5 rounded-full bg-app-elevated border border-app">
...
// ============================================================
// Indicator tile — 6-up grid of KPIs with sparkline + delta arrow
// ============================================================
  ...
  return (
    <AuthGate>
      ...
      >
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-24 space-y-6 pt-6">
          ...
          <ToolRecommendations slug="market-pulse" />
        </section>
      </div>
    </AuthGate>
  );
