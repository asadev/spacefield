...
export default function PosterCreatorApp({ width, initialParams, initialParamsKey }: NativeAppProps) {
  ...
  /* ─── Share payload (rasterize live poster, upload, mint share page) ─── */
    ...
    if (activeRef.current) {
      try {
        ...
        if (blob) {
          ...
          const res = await fetch("/api/share/upload-image", { method: "POST", body: fd });
          ...
          <div className="border-t border-app bg-app-elevated px-4 py-3 flex-shrink-0">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-3 border-t border-app pt-3">
              <div className="flex flex-col">
                ...
                <span className="text-[0.65rem] text-muted">Mints a share.example.com link any browser can open.</span>
              </div>
              <div className="flex-1" />
              <MintShareButton
                type="page"
