...
/* ───── Segmented pill row (native-style) ───── */
...
export default function DLDFeeCalculator() {
        ...
        <div
          className={
            isFrame
              ...
              : "mx-auto max-w-[1280px] px-4 py-6 sm:px-6 sm:py-10"
          }
        >
          {/* ═════════ HERO ═════════ */}
          <section className="tool-hero overflow-hidden rounded-3xl border border-app px-6 py-7 sm:px-8 sm:py-9">
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div className="min-w-0">
                ...
                <p className="mt-1.5 max-w-xl text-sm text-secondary">
                  Dubai Land Department breakdown — transfer, trustee, NOC, Oqood, and the hidden extras.
                </p>
              </div>
              <div className="dld-mono text-right text-[0.66rem] uppercase tracking-wider text-muted">
          ...
          <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,420px)_minmax(0,1fr)]">
            ...
            >
              ...
              {/* Property Type — segmented pill row */}
              <div>
                <label className="dld-mono mb-2 block text-[0.62rem] font-medium uppercase tracking-[0.22em] text-muted">
                  Property Type
                </label>
              ...
              {/* Transaction Type — segmented pill row */}
              <div>
                <label className="dld-mono mb-2 block text-[0.62rem] font-medium uppercase tracking-[0.22em] text-muted">
                  Transaction Type
                </label>
                ...
                <AnimatePresence mode="wait">
                  {result && showResult ? (
                    ...
                    >
                      ...
                      {/* Itemised rows by category — alternating bg */}
          ...
          {!isFrame && <ToolRecommendations slug="dld-fee-calculator" />}
        </div>
      </div>
    </AuthGate>
  );
