...
export default function GoldenVisaCheckerPage() {
  return (
    <Suspense fallback={null}>
      <GoldenVisaCheckerInner />
    </Suspense>
  );
}

function GoldenVisaCheckerInner() {
  ...
  const getShareText = useCallback(() => {
    ...
    const statusText = result.status === "eligible"
      ? "Eligible"
  ...
  const requirements = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        met: propertyStatus !== "off-plan" || true, // assumed true; visual cue only
      },
    ];
      ...
      >
        {!isFramed && (
          <PageHeader
            ...
            description="Check if your Dubai property investment qualifies for the UAE Golden Visa. Instant eligibility assessment with document checklist."
            color="purple"
          />
        )}

        <div className="max-w-3xl mx-auto px-5 sm:px-6 pt-6 pb-20">
          {/* ───── Verdict Hero (shows live equity threshold) ───── */}
            ...
            <div className="relative overflow-hidden rounded-2xl border border-tool-accent/30 bg-tool-accent-soft p-6 sm:p-7">
              ...
              <div className="relative grid gap-6 sm:grid-cols-[1fr_auto] items-center">
                <div>
                  ...
                  <h1 className="text-4xl sm:text-5xl font-bold text-app tracking-tight">
                    {result ? verdictLabel : "Awaiting input"}
                  </h1>
                  <p className="text-sm text-secondary mt-2 max-w-md leading-relaxed">
                    {result
                      ? result.headline
                      : "Enter your property details below — we'll score it against UAE Golden Visa thresholds in real time."}
                  </p>
                  {result?.category && (
                ...
                <div className="relative w-[140px] h-[140px] mx-auto sm:mx-0">
                  <svg width="140" height="140" className="-rotate-90">
                    ...
                    <motion.circle
                      ...
                      animate={{
                        strokeDashoffset:
                          2 * Math.PI * 58 * (1 - (result ? dialPct : thresholdPct) / 100),
                      }}
                ...
                <div className="rounded-xl border border-app bg-app-elevated p-5">
                  ...
                  <div className="space-y-1">
                    <Link
                      ...
                      className="flex items-center justify-between py-3 px-1 text-sm text-secondary hover:text-tool-accent transition-colors"
                    >
                    ...
                    <Link
                      ...
                      className="flex items-center justify-between py-3 px-1 text-sm text-secondary hover:text-tool-accent transition-colors border-t border-app"
                    >
          ...
          <section className="mt-16">
            <h2 className="text-2xl font-bold text-app mb-2">Frequently Asked Questions</h2>
            <p className="text-sm text-muted mb-6">
          ...
          {/* ───── disclaimer ───── */}
          <div className="mt-12 p-5 rounded-xl border border-app bg-app-elevated">
          ...
          <ToolRecommendations slug="golden-visa-checker" />
        </div>
      </div>
    </AuthGate>
  );
