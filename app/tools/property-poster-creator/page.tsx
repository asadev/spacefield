...
export default function PropertyPosterCreator() {
  ...
  return (
    <AuthGate>
      <div data-tool-theme="agent" data-tool="property-poster-creator">
        <main className="min-h-screen bg-app tool-hero">
          <section className="pb-[clamp(60px,10vw,120px)] pt-6">
            <div className="mx-auto max-w-[1500px] px-4 lg:px-6">
              <motion.div
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, ease }}
                className="overflow-hidden rounded-2xl border border-app bg-app-elevated shadow-elevated"
              >
                {/* Template picker — horizontal pill row */}
                <div className="border-b border-app bg-app-elevated px-4 py-3">
                  <div className="flex items-center gap-3">
                    <span className="hidden lg:block text-[0.6rem] font-semibold uppercase tracking-[0.18em] text-faint flex-shrink-0">Template</span>
                ...
                <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="flex-1 min-w-0 flex flex-col">
                    ...
                    {/* Canvas — keep bespoke poster look */}
                    <div className="relative flex-1 bg-[#f3f1ec] dark:bg-[#0b0e11] overflow-auto" style={{ backgroundImage: "radial-gradient(circle at 1px 1px, rgba(0,0,0,0.08) 1px, transparent 0)", backgroundSize: "22px 22px" }}>
                      <div className="flex items-center justify-center min-h-[480px] p-6 lg:p-10">
                    ...
                    {/* Download bar */}
                    <div className="border-t border-app bg-app-elevated px-4 py-3">
                  ...
                  {/* === Style / Branding panel (right) === */}
                  <aside className="w-full lg:w-[340px] flex-shrink-0 border-t lg:border-t-0 lg:border-l border-app bg-app">
                    {/* Panel tabs */}
                    ...
                    {/* Panel content */}
                    <div className="p-4 max-h-[72vh] overflow-y-auto scrollbar-thin">
                      <AnimatePresence mode="wait">
              ...
              <div className="mt-10">
                <ToolRecommendations slug="property-poster-creator" />
              </div>
            </div>
          </section>
        </main>
