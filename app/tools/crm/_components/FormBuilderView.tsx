...
interface FormDef {
  ...
  multiStep?: boolean;
  tracking?: boolean;
  /** Webhook URL fired on each share.example.com submission. Optional. */
  webhookUrl?: string;
  /** Email address notified on each share.example.com submission. Optional. */
  notifyEmail?: string;
              ...
              <div className="mb-2 flex items-center justify-between gap-2">
                <div>
                  ...
                  <div className="mt-0.5 text-xs text-secondary">
                    Mint a share.example.com URL to send to leads — no embed needed.
                  </div>
                </div>
                <span className="rounded-md border border-app bg-app px-2 py-0.5 font-mono text-[0.55rem] uppercase tracking-[0.16em] text-faint">
