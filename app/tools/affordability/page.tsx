  ...
  return (
    <div>
      ...
      <input
        ...
        style={{ ["--pct" as any]: `${Math.min(100, Math.max(0, pct))}%` }}
      />
      <input
        type="number"
        value={value}
...
function AffordabilityInner() {
  ...
  return (
    <AuthGate>
      <div data-tool-theme="calculators" data-tool="affordability" className="tool-root">
        <style jsx global>{`
        ...
        <main className="min-h-screen bg-app text-app">
          <div className={`mx-auto ${frame ? "max-w-full px-4 py-4" : "max-w-[1280px] px-4 py-8 lg:px-8"}`}>
            {/* Tabs (basic / advanced) */}
            {!frame && (
            ...
            <div className="overflow-hidden rounded-2xl border border-app bg-app-elevated shadow-[0_20px_60px_-30px_rgba(15,23,42,0.25)]">
              ...
              <div className="grid gap-0 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]">
                ...
                <form
                  ...
                  className="border-b border-app p-6 lg:border-b-0 lg:border-r"
                >
                  <div className="mb-5">
                  ...
                  <AnimatePresence mode="wait">
                    {!showResults || !result ? (
                      <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="flex min-h-[600px] items-center justify-center p-10"
                      >
                      ...
                      >
                        {/* Hero — "you can afford" */}
                        <div className="tool-hero relative overflow-hidden p-8 lg:p-10">
                          <div className="relative">
                            ...
                            <motion.p
                              ...
                              className="hero-number mt-1 text-5xl font-bold text-tool-accent sm:text-6xl lg:text-7xl"
                            >
                        ...
                        {bindingConstraint === "dbr" && dtiRatio >= 0.49 && (
                          <motion.div
                            ...
                            className="border-b border-app bg-tool-accent-soft px-6 py-4 lg:px-10"
                          >
                        ...
                        {/* Scenario strip */}
                        <div className="grid grid-cols-3 border-t border-app bg-app">
            ...
            <AnimatePresence mode="wait">
              {showResults && result && (
                ...
                >
                  ...
                  <div className="relative rounded-xl border border-app bg-app-elevated p-6 lg:p-8">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <Link
                      ...
                      className="group flex items-center justify-between rounded-xl border border-app bg-app-elevated p-5 transition-all hover:-translate-y-0.5 hover:border-tool-accent hover:shadow-lg focus:outline-none focus:ring-2 ring-tool-accent"
                    >
                      <div>
                    ...
                    <Link
                      href="/tools/service-charge-comparison"
                      className="group flex items-center justify-between rounded-xl border border-app bg-app-elevated p-5 transition-all hover:-translate-y-0.5 hover:border-tool-accent hover:shadow-lg focus:outline-none focus:ring-2 ring-tool-accent"
                    >
                      <div>
                        <p className="text-[0.6rem] uppercase tracking-[0.2em] text-muted">Next Step</p>
            ...
            {!frame && <ToolRecommendations slug="affordability" />}
          </div>
        </main>
      </div>
    </AuthGate>
