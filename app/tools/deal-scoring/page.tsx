...
/* ───── Score Dial ───── */
function ScoreDial({ score, label }: { score: number; label: ScoreBreakdown["label"] }) {
  const radius = 110;
    ...
    <div className="relative mx-auto flex h-[260px] w-[260px] items-center justify-center">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <motion.div
          ...
          className="text-7xl font-semibold tracking-tight tabular-nums text-tool-accent"
        >
          {score}
        </motion.div>
        <div className="text-[0.6rem] uppercase tracking-[0.3em] text-muted">
          {label} · out of 100
        </div>
      </div>
    </div>
    ...
    <AuthGate>
      ...
      >
        <div className="tool-hero border-b border-app">
          <div className="mx-auto max-w-[1280px] px-6 pt-8 pb-6 lg:px-10">
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-tool-accent-soft border border-tool-accent/30">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 24 24"
                ...
                <p className="mt-2 max-w-xl text-sm text-secondary">
                  Certified verdict on any Dubai listing. Yield, valuation, and
                  risk — scored 0 to 100.
                </p>
              </div>
        ...
        <section className="pb-[clamp(80px,12vw,160px)]">
          <div className="mx-auto max-w-[1280px] px-6 pt-8 lg:px-10">
                ...
                <AnimatePresence mode="wait">
                  {showResults && result && playbook ? (
                    ...
                    >
                      ...
                      <div className="bg-app-elevated relative overflow-hidden rounded-xl border border-app p-6 transition-colors">
                        ...
                        <div className="relative">
                          ...
                          <ScoreDial score={result.total} label={result.label} />
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1 }}
                      exit={{ opacity: 0 }}
                      className="bg-app-elevated flex min-h-[480px] flex-col items-center justify-center rounded-xl border border-dashed border-app p-8 text-center transition-colors"
                    >
            ...
            <div className="mt-12">
              <ToolRecommendations slug="deal-scoring" />
            </div>
          </div>
        </section>
      </div>
      ...
      >
        {options.map((o) => (
          <button
            ...
            className={`rounded-lg border px-3 py-2.5 text-[0.65rem] uppercase tracking-[0.12em] transition-all ${
              value === o.value
