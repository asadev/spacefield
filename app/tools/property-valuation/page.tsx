...
export default function PropertyValuationPage() {
  return (
    <Suspense fallback={null}>
      <PropertyValuationInner />
    </Suspense>
  );
}

function PropertyValuationInner() {
  ...
  useEffect(() => {
    ...
    ctx.textAlign = "right";
    ctx.fillText(formatAED(rangeMax), width - 20, cy + 20);
  ...
  useEffect(() => {
    ...
    const barWidth = (width - padding.left - padding.right) / prices.length - 8;
    const chartHeight = height - padding.top - padding.bottom;

    prices.forEach((p, i) => {
      const x = padding.left + i * ((width - padding.left - padding.right) / prices.length) + 4;
      ...
      ctx.fillText(p.label, x + barWidth / 2, height - 12);
    });
      ...
      >
        {!isFramed && (
          <PageHeader
            ...
            description="Comparable-based AVM for Dubai properties. Defensible market estimate from inputs you control."
            color="amber"
          />
        )}
        <div className="max-w-3xl mx-auto">
          ...
          <section className="px-4 sm:px-6 pt-5">
            <motion.div
              ...
              className="relative bg-tool-accent-soft border border-tool-accent/30 rounded-2xl p-6 sm:p-8 overflow-hidden"
            >
              ...
              <div className="relative">
                ...
                <p className="font-mono text-4xl sm:text-5xl font-bold text-app tabular-nums tracking-tight">
                  {valuation
          ...
          <nav className="px-4 sm:px-6 pt-5">
          ...
          {/* Body */}
          <section className="px-4 sm:px-6 pt-5 pb-12">
            <AnimatePresence mode="wait">
              {activeTab === "inputs" && (
                ...
                >
                  ...
                  {/* Run footer */}
                  <div className="h-px bg-app" />
                  <div className="p-5 sm:p-6 flex items-center justify-between gap-3 flex-wrap">
              ...
              {activeTab === "result" && showResults && valuation && (
                ...
                >
                  ...
                  {valuation.verdict && (() => {
                    ...
                    return (
                      <div className="bg-app-elevated border border-app rounded-2xl p-5 sm:p-6">
            ...
            {/* Recommendations */}
            <div className="mt-12">
              <ToolRecommendations slug="property-valuation" />
            </div>
          </section>
        </div>
      </div>
