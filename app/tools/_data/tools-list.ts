...
export const TOOLS: ToolItem[] = [
  ...
  // Productivity
  { slug: "meeting-cost-calculator", title: "Meeting Cost Calculator", description: "Add attendees, set hourly rates, pick a duration. See exactly what a meeting costs before you book it.", category: "productivity", icon: "clock", route: "/solutions/tools/meeting-cost-calculator" },
  { slug: "time-zone-planner", title: "Time-zone Meeting Planner", description: "Compare business hours across up to five time zones and pick the least painful overlap.", category: "productivity", icon: "globe", route: "/solutions/tools/time-zone-planner" },
  ...
  { slug: "world-clock", title: "World Clock", description: "Track up to 12 cities with live times and business-hours indicators. Know who's working, who's asleep, who's on the edge.", category: "productivity", icon: "globe", route: "/solutions/tools/world-clock" },
  ...
  // Finance
  { slug: "loan-calculator", title: "Loan / EMI Calculator", description: "Calculate monthly payment, total interest, and full amortization schedule for any fixed-rate loan.", category: "finance", icon: "calculator", route: "/solutions/tools/loan-calculator" },
  { slug: "compound-interest", title: "Compound Interest Calculator", description: "Model investment growth with monthly contributions and compounding. See the curve, not just the number.", category: "finance", icon: "trending", route: "/solutions/tools/compound-interest" },
  ...
  { slug: "rule-of-40", title: "Rule of 40 Calculator", description: "SaaS Rule of 40 score with FCF or EBITDA margin toggle. Verdict tiers plus a public-SaaS benchmark table for context.", category: "finance", icon: "percent", route: "/solutions/tools/rule-of-40" },
  { slug: "saas-quick-ratio", title: "SaaS Quick Ratio", description: "(New + expansion) / (churn + contraction). Get Quick Ratio, NRR, GRR, net new MRR, and ending MRR from one month of flows.", category: "finance", icon: "chart", route: "/solutions/tools/saas-quick-ratio" },
  { slug: "cohort-arr-projection", title: "Cohort ARR Projection", description: "Project ARR over 24 months from monthly new-customer cohorts and a logo retention curve. Steady-state ARR and effective churn included.", category: "finance", icon: "trending", route: "/solutions/tools/cohort-arr-projection" },
  ...
  { slug: "cohort-retention", title: "Cohort Retention Analyzer", description: "Paste signup + last-active CSV and render a monthly cohort retention heatmap up to 12 months out.", category: "marketing", icon: "grid", route: "/solutions/tools/cohort-retention" },
  ...
  // Data & Developer
  { slug: "qr-code-generator", title: "QR Code Generator", description: "Generate a QR code from any URL or text. Download as SVG. Runs entirely in your browser.", category: "data", icon: "grid", route: "/solutions/tools/qr-code-generator" },
  ...
  { slug: "password-strength", title: "Password Strength & Entropy", description: "Measure entropy in bits, estimate brute-force time, and see what's weakening your password.", category: "data", icon: "lock", route: "/solutions/tools/password-strength" },
  ...
  { slug: "jwt-decoder", title: "JWT Decoder", description: "Decode JWT header, payload, and signature. Detect expired tokens and verify HS256 signatures locally via SubtleCrypto.", category: "data", icon: "lock", route: "/solutions/tools/jwt-decoder" },
  { slug: "url-encoder-parser", title: "URL Encoder & Parser", description: "Split a URL into protocol, host, path, and editable query params. Tabs for encodeURIComponent, decodeURIComponent, and base64.", category: "data", icon: "code", route: "/solutions/tools/url-encoder-parser" },
  ...
  { slug: "base64-encoder", title: "Base64 Encoder / Decoder", description: "Encode or decode text and files to Base64 or URL-safe Base64. Auto-detects encoded input. Runs entirely in your browser.", category: "data", icon: "code", route: "/solutions/tools/base64-encoder" },
  { slug: "hash-generator", title: "Hash Generator", description: "Compute MD5, SHA-1, SHA-256, SHA-512 of text or files. MD5 via pure-JS, SHA family via SubtleCrypto. No upload — local only.", category: "data", icon: "hash", route: "/solutions/tools/hash-generator" },
  { slug: "http-status-reference", title: "HTTP Status Reference", description: "Searchable reference for every HTTP status code with plain-English descriptions, real-world scenarios, and RFC pointers.", category: "data", icon: "list", route: "/solutions/tools/http-status-reference" },
  { slug: "lorem-ipsum-generator", title: "Lorem Ipsum Generator", description: "Generate placeholder text — classic, hipster, corporate, or pirate. Configure paragraphs, sentences, or raw word count.", category: "data", icon: "note", route: "/solutions/tools/lorem-ipsum-generator" },
  ...
  { slug: "oncall-schedule-builder", title: "On-call Schedule Builder", description: "Generate a rotation from a team list. Daily or weekly shifts, custom handoff time, ICS calendar export. Team mode shares the schedule across the workspace.", category: "support", icon: "clock", route: "/solutions/tools/oncall-schedule-builder" },
  ...
  { slug: "pirate-metrics-tracker", title: "Pirate Metrics Tracker (AARRR)", description: "Monthly Acquisition → Activation → Retention → Referral → Revenue tracker with stage conversions and trend charts. Team-shared.", category: "growth", icon: "funnel", route: "/solutions/tools/pirate-metrics-tracker" },
  ...
  // CRM & Sales Ops
  { slug: "contact-manager", title: "Contact Manager", description: "Lightweight CRM contact book with tags, statuses, owners, sources, and notes. Search, filter, merge duplicates, CSV import/export. Team-shared.", category: "crm", icon: "users", route: "/solutions/tools/contact-manager" },
  { slug: "activity-timeline", title: "Activity Timeline", description: "Log emails, calls, meetings, notes, and tasks against contacts. Chronological timeline with type and owner filters. Team-shared.", category: "crm", icon: "clock", route: "/solutions/tools/activity-timeline" },
  ...
  { slug: "email-template-library", title: "Email Template Library", description: "Named email templates with merge variables. Categories for cold outreach, follow-up, meeting, proposal, closing. Preview and copy. Team-shared.", category: "crm", icon: "mail", route: "/solutions/tools/email-template-library" },
  { slug: "lead-capture-form-builder", title: "Lead Capture Form Builder", description: "Drag-add field designer for lead forms. Text, email, phone, select, checkbox, textarea. Export as HTML snippet or JSON schema. No backend required.", category: "crm", icon: "clipboard", route: "/solutions/tools/lead-capture-form-builder" },
  { slug: "follow-up-reminder", title: "Follow-up Reminder", description: "Reminder list tied to contacts. Overdue and upcoming views, snooze by days or weeks, owner filter. Team-shared.", category: "crm", icon: "bell", route: "/solutions/tools/follow-up-reminder" },
  ...
  { slug: "territory-mapper", title: "Territory Mapper", description: "Assign regions and ZIP codes to reps. Flags overlapping territories and uncovered zones, exports assignments as CSV.", category: "crm", icon: "map", route: "/solutions/tools/territory-mapper" },
