...
export const TOOLS: ToolItem[] = [
  ...
  { slug: "investment-advisor", title: "AI Investment Advisor", description: "Answer five questions and get a shortlist of areas, property types, and deals that fit your budget, risk appetite, and target yield.", category: "intelligence", icon: "compass", app: () => import("../investment-advisor/_app").then((m) => ({ default: m.default })) },
  { slug: "property-valuation", title: "AI Property Valuation", description: "Find out what any property is actually worth — with confidence intervals and a full breakdown of how the number was reached.", category: "intelligence", icon: "home", app: () => import("../property-valuation/_app").then((m) => ({ default: m.default })) },
  { slug: "deal-scoring", title: "Deal Scoring Engine", description: "Paste a listing and know in seconds if it's a steal, fair value, or overpriced — scored 0-100 on yield, valuation, and risk.", category: "intelligence", icon: "target", app: () => import("../deal-scoring/_app").then((m) => ({ default: m.default })) },
  { slug: "market-pulse", title: "Market Pulse Dashboard", description: "See where money is flowing right now — transaction volumes, price trends, top-performing areas, and supply pipeline through 2028.", category: "intelligence", icon: "pulse", app: () => import("../market-pulse/_app").then((m) => ({ default: m.default })) },

  // Calculators
  { slug: "mortgage-calculator", title: "Mortgage Calculator", description: "Know your exact monthly payment across 10 UAE banks, stress-test at higher rates, and see LTV rules for your residency status — before you walk into a showroom.", category: "calculators", icon: "calculator", app: () => import("../mortgage-calculator/_app").then((m) => ({ default: m.default })) },
  { slug: "roi-calculator", title: "ROI Calculator", description: "See your actual return after all costs — not the inflated number the brochure shows you. Factors in every expense most calculators ignore.", category: "calculators", icon: "trending", app: () => import("../roi-calculator/_app").then((m) => ({ default: m.default })) },
  ...
  // Investment Tools
  { slug: "rent-vs-buy", title: "Rent vs Buy Calculator", description: "Get the real answer for UAE — factoring in zero income tax, RERA rent caps, Golden Visa eligibility, and opportunity cost. See your exact breakeven year.", category: "investment", icon: "scale", app: () => import("../rent-vs-buy/_app").then((m) => ({ default: m.default })) },
  { slug: "offplan-analyzer", title: "Off-Plan Payment Analyzer", description: "Compare up to 3 developer payment plans side-by-side. See which 60/40, 1% monthly, or post-handover structure actually costs you less in real terms.", category: "investment", icon: "building", app: () => import("../offplan-analyzer/_app").then((m) => ({ default: m.default })) },
  ...
  { slug: "neighborhood-report", title: "Neighborhood Quality Report", description: "Get the honest picture of any community before you commit — scored across six categories with a downloadable PDF you can share with clients.", category: "research", icon: "pin", app: () => import("../neighborhood-report/_app").then((m) => ({ default: m.default })) },
  { slug: "yield-heatmap", title: "Rental Yield Heatmap", description: "Stop guessing where yields are highest. Click any zone on the map and see exactly what landlords are earning there.", category: "research", icon: "grid", app: () => import("../yield-heatmap/_app").then((m) => ({ default: m.default })) },
  ...
  // Agent Tools
  { slug: "sales-offer-generator", title: "Sales Offer Generator", description: "Stop spending 30 minutes formatting offers. Input the deal details and get a structured, ready-to-send sales offer in seconds.", category: "agent", icon: "document", app: () => import("../sales-offer-generator/_app").then((m) => ({ default: m.default })) },
  { slug: "poster-creator", title: "Poster Creator", description: "Generate posters for any industry — real estate, fashion, food, services and more. Industry-keyed templates, drag photos in, download in high res.", category: "agent", icon: "image", app: () => import("../poster-creator/_app").then((m) => ({ default: m.default })) },
  ...
  // Legal / Compliance
  { slug: "invoice-generator", title: "Invoice Generator", description: "Fill a form, preview the invoice, print or save as PDF via the browser. No accounts, no watermarks.", category: "legal", topRated: true, icon: "receipt", route: "/solutions/tools/invoice-generator", app: () => import("../../solutions/tools/invoice-generator/_app").then((m) => ({ default: m.default })) },
  ...
  { slug: "json-formatter", title: "JSON Formatter & Validator", description: "Pretty-print, minify, and validate JSON. Identifies the exact line and column of any syntax error.", category: "data", topRated: true, icon: "code", route: "/solutions/tools/json-formatter" },
  ...
  { slug: "seo-meta-tags", title: "SEO Meta Tags", description: "Generate clean HTML meta tags with Google SERP + Twitter card previews. Warns when title or description exceed recommended length.", category: "content", topRated: true, icon: "tag", route: "/solutions/tools/seo-meta-tags" },
  ...
  { slug: "deal-pipeline-board", title: "Deal Pipeline Board", description: "Kanban sales pipeline across Prospecting → Qualified → Proposal → Negotiation → Closed. Drag to move stage, totals per column. Team-shared.", category: "crm", topRated: true, icon: "kanban", route: "/solutions/tools/deal-pipeline-board", app: () => import("../../solutions/tools/deal-pipeline-board/_app").then((m) => ({ default: m.default })) },
  ...
  { slug: "chat", title: "Chat", description: "Real-time messaging within this workspace. Share files and photos that count against the workspace storage cap.", category: "files", topRated: true, icon: "message", route: "/tools/chat", defaultSize: { w: 960, h: 640 }, minSize: { w: 520, h: 420 }, app: () => import("../chat/_app").then((m) => ({ default: m.default })) },
  ...
  { slug: "documents", title: "Documents", description: "Write, edit, and save Word-style documents inside your workspace. Real .docx round-trip, autosave, tables, lists, code, links.", category: "files", topRated: true, icon: "document", defaultSize: { w: 880, h: 640 }, minSize: { w: 480, h: 360 }, app: () => import("../documents/_app").then((m) => ({ default: m.default })) },

  // Sheets — Excel-style spreadsheets with real .xlsx round-trip.
  { slug: "sheets", title: "Sheets", description: "Excel-style spreadsheets in your workspace. Formulas, multiple sheets, conditional formatting. Real .xlsx round-trip — opens in Numbers, Excel, Google Sheets.", category: "files", topRated: true, icon: "grid", defaultSize: { w: 1100, h: 720 }, minSize: { w: 640, h: 420 }, app: () => import("../sheets/_app").then((m) => ({ default: m.default })) },
];
