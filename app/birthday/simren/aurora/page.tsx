...
/* Aurora variant — dark, three.js GLSL aurora shader sky + falling snow + drifting polaroids. */

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: "Happy Birthday, Simren — Aurora",
...
export default function Page() {
  return <AuroraExperience photos={readPhotos()} />;
}
