...
const VARIANTS: Variant[] = [
  {
    slug: "cosmic",
    name: "Cosmic",
    tagline: "A drift through stars and warm dust.",
    mode: "dark",
    accent: "linear-gradient(135deg, #1a0f2e, #3a1f5e, #ff7eb3)",
    live: true,
  },
  {
    slug: "garden",
  ...
  },
  {
    slug: "cinema",
    name: "Cinema",
    tagline: "A reel of small moments.",
    mode: "dark",
    accent: "linear-gradient(135deg, #0a0a0a, #2a2a2a, #d4af37)",
    live: true,
  },
  {
    slug: "paper",
    name: "Paper",
    tagline: "Soft cream, hand-drawn warmth.",
    mode: "light",
    accent: "linear-gradient(135deg, #fdf8f0, #f0d9c3, #d49a82)",
    live: true,
  },
  {
    slug: "glass",
    name: "Glass",
    tagline: "Light through frosted edges.",
    mode: "light",
    accent: "linear-gradient(135deg, #e8f0ff, #c8d8f0, #a0b8e0)",
    live: true,
  },
  {
    slug: "museum",
    name: "Museum",
    tagline: "An editorial wall, generously hung.",
    mode: "light",
    accent: "linear-gradient(135deg, #fafafa, #e8e6e1, #b8b3a8)",
    live: true,
  },
  {
    slug: "aurora",
    name: "Aurora",
    tagline: "Northern lights and quiet snow.",
    mode: "dark",
    accent: "linear-gradient(135deg, #001a33, #004d4d, #66ffcc)",
    live: true,
  },
  {
    slug: "bloom",
    name: "Bloom",
    tagline: "Saffron, henna, and heritage.",
    mode: "light",
    accent: "linear-gradient(135deg, #fff5e6, #f4c97e, #b85042)",
    live: true,
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          made with care · share.example.com
        </p>
      </div>
