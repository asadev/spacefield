...
/* Paper variant — light, cream-paper texture, hand-drawn pencil cake,
 * torn-edge polaroids, watercolor splashes, handwritten wishes. */

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: "Happy Birthday, Simren — Paper",
...
export default function Page() {
  return <PaperExperience photos={readPhotos()} />;
}
