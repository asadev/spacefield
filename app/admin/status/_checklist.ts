...
export const CHECKLIST: Item[] = [
  ...
  { id: "scan-sd-002-share-mint-rate", category: "security", phase: "hardening", title: "[SD-002] /api/share/mint: no rate-limit, no slug allowlist", status: "missing", priority: "P0", effort: "S", notes: "app/api/share/mint/route.ts:14-40. Add rate-limit (30/60s) + reserved-slug list (signin/admin/api/spacefield/etc)." },
