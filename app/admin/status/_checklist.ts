...
export const CHECKLIST: Item[] = [
  ...
  { id: "structured-logging", category: "observability", phase: "hardening", title: "Structured JSON logging on every request", status: "partial", priority: "P1", effort: "S", notes: "lib/log.ts shipped 2026-05-13 (level/evt/ts/meta shape). Next: thread request_id into the logger + migrate existing console.log calls." },
  { id: "request-id", category: "observability", phase: "hardening", title: "Request ID correlation across layers", status: "partial", priority: "P1", effort: "S", notes: "Shipped 2026-05-13 — middleware sets X-Request-Id on every response. Next step: thread it into the structured logger so log lines carry it." },
