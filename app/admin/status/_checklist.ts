...
export const CHECKLIST: Item[] = [
  ...
  },
  {
    id: "share",
    category: "product",
    title: "Share universal sharing (share.example.com)",
    status: "done",
    priority: "P1",
    notes:
  ...
  },
  {
    ...
    priority: "P1",
    notes:
      "Admin moderation page exists. Automated moderation on Share-published AI output not wired. Reputational risk if a posted listing contains slurs/PII.",
  },
  {
  ...
  },
  {
    ...
    priority: "P2",
    notes:
      "Supabase Pro+ supports read replicas. Analytics queries (Share aggregates, admin insights) should hit a replica to spare the primary.",
  },
  ...
  },
  {
    ...
    priority: "P2",
    notes:
      "Cloudflare Turnstile (free, invisible). Prevents signup spam + Share link spam. Trivial to add.",
  },
  {
    id: "file-upload-scan",
    category: "security",
