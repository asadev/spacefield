...
export const CHECKLIST: Item[] = [
  ...
  { id: "account-lockout", category: "security", phase: "hardening", title: "Account lockout on brute-force", status: "done", priority: "P1", effort: "S", notes: "Shipped 2026-05-17 (S5): record_auth_failure RPC + auth_failures + account_lockouts tables. Default 6 failures / 10min window / 30min lock (tunable via env). lib/security/lockout.ts ready to wire into sign-in." },
  ...
  { id: "scan-sc-003-error-leak", category: "security", phase: "hardening", title: "[SC-003] Raw DB error messages echoed to API clients", status: "partial", priority: "P1", effort: "M", notes: "PARTIAL: V-5 (May-15) + S3 (May-17) swept 35 routes total — all admin/* and agent/* now use safeErrorMessage. ~53 remaining (chat/* crm/* files/* cron/* wallpapers/* toshare/* tools/* workspaces/* notifications/*) — final sweep is its own focused round." },
  ...
  { id: "scan-se-002-xlsx", category: "security", phase: "hardening", title: "[SE-002] xlsx@^0.18.5 unpatched", status: "partial", priority: "P1", effort: "M", notes: "PARTIAL 2026-05-17 (S6): exceljs@^4.4.0 added to package.json alongside xlsx. Sheets editor port (~200 lines of bidirectional xlsx↔Univer conversion) is the only blocker — TODO marked at app/tools/sheets/_editor.tsx. Focused round to follow." },
