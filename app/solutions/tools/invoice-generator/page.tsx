...
export default function InvoiceGeneratorPage() {
  ...
  return (
    <div data-tool-theme="finance" data-tool="invoice-generator">
      <ToolShell
        category="Legal & Compliance"
        title="Invoice Generator"
        description="Fill a form, preview the invoice, print or save as PDF via the browser. No accounts, no watermarks."
      >
        ...
        {tab === "edit" && (
          <div className="rounded-xl border border-app bg-app-elevated p-5 no-print">
            <ToolCard title="Invoice details" subtitle="Edit">
        ...
        {tab === "export" && (
          <div className="rounded-xl border border-app bg-app-elevated p-5">
            <ToolCard title="Export" subtitle="Print / save">
