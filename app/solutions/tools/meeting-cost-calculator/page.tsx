...
export default function MeetingCostCalculatorPage() {
  ...
  return (
    <ToolShell
      ...
      description="Add attendees, their hourly rates, and the duration. Hit start and watch the bill climb."
    >
      <div
      ...
      >
        ...
        <section className="grid grid-cols-1 gap-6 lg:grid-cols-[1.3fr_1fr]">
          ...
          <aside className="rounded-2xl border border-app bg-tool-surface p-5 shadow-sm">
            ...
            <div
              className={`mt-4 rounded-md border px-3 py-2 font-mono text-[0.7rem] ${recChipClass.replace(
                "bg-",
                "bg-"
              )}`}
            >
              ...
              {attendees.map((a, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="w-40 truncate text-app">{a.role || "—"}</span>
