...
export default function PlanningPokerPage() {
  ...
  return (
    <div data-tool-theme="productivity" data-tool="planning-poker">
      <ToolShell
        category="Productivity"
        title="Planning Poker Estimator"
        description="Collect Fibonacci estimates from up to 8 team members. See consensus, spread, and stories with high disagreement."
      >
        {/* Estimation table */}
        <section className="relative overflow-hidden rounded-2xl border border-app bg-app-elevated p-4 sm:p-5">
          ...
          <div className="relative grid grid-cols-1 gap-5 lg:grid-cols-[260px_1fr]">
