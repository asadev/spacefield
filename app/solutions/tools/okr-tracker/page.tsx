...
export default function OkrTrackerPage() {
  ...
  return (
    <div data-tool-theme="productivity" data-tool="okr-tracker">
      <ToolShell
        category="Productivity"
        title="OKR Tracker"
        description="Objectives and their key results, per quarter. Each KR has a current value and a target — progress is computed automatically."
      >
        {/* ============================== MASTHEAD ============================== */}
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-2 flex items-center gap-2">
                  <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-tool-accent text-app-elevated shadow-sm" style={{ color: "var(--bg)" }}>
        ...
        {rollup.perObjective.length > 1 && (
          <section className="mb-6">
            <ToolCard title="Weighted rollup" subtitle={`Across ${rollup.perObjective.length} objectives`}>
            ...
            <div className="flex flex-wrap items-start gap-3">
              <div className="min-w-[220px] flex-1">
                ...
                <div className="mt-2 flex flex-wrap items-center gap-2">
                  ...
                  <label className="inline-flex items-center gap-1.5 rounded-md border border-app bg-app px-2.5 py-1 text-xs text-secondary">
                    <span className="font-mono text-[0.6rem] uppercase tracking-wider text-muted">w</span>
                    <input
                      type="number"
                      value={o.weight ?? 1}
                      onChange={(e) =>
